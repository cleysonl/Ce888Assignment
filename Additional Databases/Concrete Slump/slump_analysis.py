...
data = pd.read_csv('data_slump.csv')
...
X_train, X_test, y_train, y_test = train_test_split(data.drop(['SLUMP(cm)','FLOW(cm)','Compressive Strength (28-day)(Mpa)'],axis='columns'),data['Compressive Strength (28-day)(Mpa)'],test_size=0.2)
print(X_train.shape)
print(X_test.shape)
